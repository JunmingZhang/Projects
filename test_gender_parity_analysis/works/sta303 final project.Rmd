...
![gender's salary compare in 2020 Q4](images/salcompare.png)
![gender's status in hiring phases](images/statushire.png)
...
```{r eda_current_employees, include=FALSE, echo=FALSE, warning=FALSE, message=FALSE}
black_saber_current_employees <- read_csv("data/black-saber-current-employees.csv")
...
![gender's salary varies in teams](images/salteam.png)

![gender's salary varies in roles](images/salrole.png)
...
![gender's leadership level](images/levleader.png)
...
```{r salary_gender_V0, include=FALSE, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r salary_gender_V1, include=FALSE, echo=FALSE, warning=FALSE, message=FALSE}
# m1 = lmer(salary~gender + leadership_for_level + productivity + (1|team), data=current_employees)
# m2 = lmer(salary~gender + leadership_for_level + productivity + (1|role_seniority), data=current_employees)
...
```{r salary_gender_V2, include=FALSE, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r salary final, include=FALSE, echo=FALSE, warning=FALSE, message=FALSE}
# m3 = lmer(salary~gender + leadership_for_level + productivity + (team|role_seniority), data=current_employees)
...
```{r salary model summary, include=FALSE, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r promotion_gender, include = FALSE, echo=FALSE, warning=FALSE, message=FALSE}
...
promotion_data <- employees %>%
  group_by(employee_id) %>%
  summarise(gender, team, years_of_service, num_promotion = length(unique(role_seniority)) - 1, qs = n()) %>%
  distinct_all()
...
``` {r count 0, include=FALSE, echo=FALSE, message=FALSE}
...
```{r zip v1 , include=FALSE, echo=FALSE, message=FALSE}
...
# it increases the
m7 = zeroinfl(num_promotion~gender + offset(years_of_service) | team, data=promotion_data)
lrtest(m1, m7)
...
```{r zip v2 , include=FALSE, echo=FALSE, message=FALSE}
...
```{r promotion gender, include=FALSE, echo=FALSE, warning=FALSE, message=FALSE}
# test if gender is important for influencing promotion
model_promotion_no_gender = zeroinfl(num_promotion~offset(years_of_service) | no_expectation, data=promotion_data)
...
```{r promotion model summary, include=FALSE, echo=FALSE, warning=FALSE, message=FALSE}
...
![gender's occupation in speaking skills](images/speakskill.png)




![gender's occupation in leadership presence](images/leaderpresence.png)
